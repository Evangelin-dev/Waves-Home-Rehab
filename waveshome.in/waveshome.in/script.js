...
document.addEventListener("DOMContentLoaded", function () {
    const observer = new IntersectionObserver(
        ...
        { threshold: 0.2 } // Adjust threshold for better timing
    );

    document.querySelectorAll(".animate, .animate-title, .animate-subtitle, .animate-text").forEach(element => {
        observer.observe(element);
    });
});

//rehabilities and registration scroll
document.addEventListener("DOMContentLoaded", function() {
